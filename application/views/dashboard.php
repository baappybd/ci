			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url(); ?>Admin/add_student"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Student</span></a></li>
                        <li><a href="<?php echo base_url(); ?>Admin/manage_student"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Student</span></a></li>
                        <li><a href="<?php echo base_url(); ?>Admin/edit_admin"><i class="icon-tasks"></i><span class="hidden-tablet"> Admin</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
